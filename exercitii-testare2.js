class Ex1{
    ...
    count = 0;
    rezultat_corect1 = -100000;
    rezultat_corect2 = -100000;
    rezultat_corect3 = -100000;
    ...
    verificare(param) {
        ...
        this.rezultat_corect3 = this.rezultat_corect2;
        this.rezultat_corect2 = this.rezultat_corect1;
        this.rezultat_corect1 = rasp_corect;
        if (param === rasp_corect) {
            ...
            if (this.rezultat_corect1 !== this.rezultat_corect2 || this.rezultat_corect2 !== this.rezultat_corect3)
            {
                count++;
            }
            else count = 0;
