import Ex1 from "../mutanti/mutant10.js";
import { expect } from "chai";
var myObj = new Ex1();

describe("Testare functionala - Mutant10" , function (){
    ...
    it("Respecta toate constrangerile", function(){
        ...
        expect(myObj.rezolvare(2, 3, 6, 3, 4, 8)).to.be.equal(2); // pentru omorarea mutantului 10
    });
...
describe("Testare structurala - Mutant10", function() {
